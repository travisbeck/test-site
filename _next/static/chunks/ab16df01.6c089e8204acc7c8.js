"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[2533],{

/***/ 16610:
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   M: function() { return /* binding */ Editor; }
/* harmony export */ });
...
/* harmony import */ var eventemitter3__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(10161);
/* harmony import */ var _config_createTLUser_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(41276);
/* harmony import */ var _config_defaultShapes_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(80492);
/* harmony import */ var _constants_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(38021);
/* harmony import */ var _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(84527);
/* harmony import */ var _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(46921);
/* harmony import */ var _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(80489);
/* harmony import */ var _primitives_easings_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(80695);
/* harmony import */ var _primitives_geometry_Group2d_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(24196);
/* harmony import */ var _primitives_intersect_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(96284);
/* harmony import */ var _primitives_utils_mjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(20930);
/* harmony import */ var _utils_SharedStylesMap_mjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(85592);
/* harmony import */ var _utils_WeakMapCache_mjs__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(8662);
/* harmony import */ var _utils_assets_mjs__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(66745);
/* harmony import */ var _utils_getIncrementedName_mjs__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(92226);
/* harmony import */ var _utils_reorderShapes_mjs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(65693);
/* harmony import */ var _utils_rotation_mjs__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(99590);
/* harmony import */ var _utils_uniqueId_mjs__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(73565);
/* harmony import */ var _derivations_arrowBindingsIndex_mjs__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(23338);
/* harmony import */ var _derivations_parentsToChildren_mjs__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(13638);
/* harmony import */ var _derivations_shapeIdsInCurrentPage_mjs__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(42731);
/* harmony import */ var _managers_ClickManager_mjs__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(97540);
/* harmony import */ var _managers_EnvironmentManager_mjs__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(90663);
/* harmony import */ var _managers_HistoryManager_mjs__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(10795);
/* harmony import */ var _managers_ScribbleManager_mjs__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(86906);
/* harmony import */ var _managers_SideEffectManager_mjs__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(37572);
/* harmony import */ var _managers_SnapManager_SnapManager_mjs__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(79461);
/* harmony import */ var _managers_TextManager_mjs__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(85289);
/* harmony import */ var _managers_TickManager_mjs__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(65650);
/* harmony import */ var _managers_UserPreferencesManager_mjs__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(7367);
/* harmony import */ var _shapes_shared_arrow_curved_arrow_mjs__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(97279);
/* harmony import */ var _shapes_shared_arrow_shared_mjs__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(35407);
/* harmony import */ var _shapes_shared_arrow_straight_arrow_mjs__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(15937);
/* harmony import */ var _tools_RootState_mjs__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(37669);
...
class Editor extends eventemitter3__WEBPACK_IMPORTED_MODULE_3__.EventEmitter {
  constructor({
    store,
    user,
    shapeUtils,
    ...
    super();
    this.store = store;
    this.snaps = new _managers_SnapManager_SnapManager_mjs__WEBPACK_IMPORTED_MODULE_23__/* .SnapManager */ .f(this);
    this.user = new _managers_UserPreferencesManager_mjs__WEBPACK_IMPORTED_MODULE_26__/* .UserPreferencesManager */ .K(user ?? (0,_config_createTLUser_mjs__WEBPACK_IMPORTED_MODULE_4__/* .createTLUser */ .L)(), inferDarkMode ?? false);
    this.getContainer = getContainer ?? (() => document.body);
    this.textMeasure = new _managers_TextManager_mjs__WEBPACK_IMPORTED_MODULE_24__/* .TextManager */ .R(this);
    class NewRoot extends _tools_RootState_mjs__WEBPACK_IMPORTED_MODULE_30__/* .RootState */ .m {
      static initial = initialState ?? "";
    }
    this.root = new NewRoot(this);
    this.root.children = {};
    const allShapeUtils = (0,_config_defaultShapes_mjs__WEBPACK_IMPORTED_MODULE_5__/* .checkShapesAndAddCore */ .m)(shapeUtils);
    ...
    for (const Util of allShapeUtils) {
      ...
      const propKeysByStyle = (0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .getShapePropKeysByStyle */ .DR)(Util.props ?? {});
    ...
    for (const Tool of [...tools]) {
      if ((0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .hasOwnProperty */ .nr)(this.root.children, Tool.id)) {
        throw Error(`Can't override tool with id "${Tool.id}"`);
      }
      this.root.children[Tool.id] = new Tool(this, this.root);
    }
    this.environment = new _managers_EnvironmentManager_mjs__WEBPACK_IMPORTED_MODULE_31__/* .EnvironmentManager */ .l(this);
    this.scribbles = new _managers_ScribbleManager_mjs__WEBPACK_IMPORTED_MODULE_22__/* .ScribbleManager */ .o(this);
    ...
    const reparentArrow = (arrowId) => {
      ...
      if (higherSiblings.length) {
        ...
        finalIndex = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndexBetween */ .eI)(highestSibling.index, higherSiblings[0].index);
      } else {
        finalIndex = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndexAbove */ ._L)(highestSibling.index);
      }
    ...
    const unbindArrowTerminal = (arrow, handleId) => {
      const { x, y } = (0,_shapes_shared_arrow_shared_mjs__WEBPACK_IMPORTED_MODULE_28__/* .getArrowTerminalsInArrowSpace */ .Qs)(this, arrow)[handleId];
    ...
    this.sideEffects = new _managers_SideEffectManager_mjs__WEBPACK_IMPORTED_MODULE_32__/* .SideEffectManager */ .Y(this);
    ...
    this.sideEffects.registerBeforeDeleteHandler("shape", (record) => {
      if (record.parentId && (0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isShapeId */ .YT)(record.parentId)) {
      ...
      const updates = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(
    ...
    this.sideEffects.registerBeforeDeleteHandler("page", (record) => {
      ...
      const cameraId = _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .CameraRecordType */ .AN.createId(record.id);
      const instance_PageStateId = _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .InstancePageStateRecordType */ .iS.createId(record.id);
    ...
    this.sideEffects.registerAfterChangeHandler("shape", (prev, next) => {
      ...
      if (prev.parentId !== next.parentId && (0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isPageId */ .r5)(next.parentId)) {
      ...
      if (prev.parentId && (0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isShapeId */ .YT)(prev.parentId)) {
        invalidParents.add(prev.parentId);
      }
      if (next.parentId !== prev.parentId && (0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isShapeId */ .YT)(next.parentId)) {
    ...
    this.sideEffects.registerAfterChangeHandler("instance_page_state", (prev, next) => {
      if (prev?.selectedShapeIds !== next?.selectedShapeIds) {
        const filtered = next.selectedShapeIds.filter((id) => {
          ...
          while ((0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isShapeId */ .YT)(parentId)) {
        ...
        if (filtered.length > 0) {
          const commonGroupAncestor = this.findCommonAncestor(
            (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(filtered.map((id) => this.getShape(id))),
    ...
    this.sideEffects.registerAfterCreateHandler("page", (record) => {
      const cameraId = _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .CameraRecordType */ .AN.createId(record.id);
      const _pageStateId = _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .InstancePageStateRecordType */ .iS.createId(record.id);
      if (!this.store.has(cameraId)) {
        this.store.put([_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .CameraRecordType */ .AN.create({ id: cameraId })]);
      }
      if (!this.store.has(_pageStateId)) {
        this.store.put([
          _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .InstancePageStateRecordType */ .iS.create({ id: _pageStateId, pageId: record.id })
        ]);
      }
    });
    this._currentPageShapeIds = (0,_derivations_shapeIdsInCurrentPage_mjs__WEBPACK_IMPORTED_MODULE_19__/* .deriveShapeIdsInCurrentPage */ .Q)(
      this.store,
      () => this.getCurrentPageId()
    );
    this._parentIdsToChildIds = (0,_derivations_parentsToChildren_mjs__WEBPACK_IMPORTED_MODULE_18__/* .parentsToChildren */ .s)(this.store);
  ...
  /** @internal */
  _tickManager = new _managers_TickManager_mjs__WEBPACK_IMPORTED_MODULE_25__/* .TickManager */ .r(this);
  /**
  ...
  getShapeUtil(arg) {
    ...
    const shapeUtil = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnProperty */ .eg)(this.shapeUtils, type);
    (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .hu)(shapeUtil, `No shape util found for type "${type}"`);
    return shapeUtil;
  }
  /* --------------------- History -------------------- */
  /**
   ...
   * @readonly
   */
  history = new _managers_HistoryManager_mjs__WEBPACK_IMPORTED_MODULE_21__/* .HistoryManager */ .E(
    this,
    // () => this._complete(),
    (error) => {
  ...
  _getArrowBindingsIndex() {
    return (0,_derivations_arrowBindingsIndex_mjs__WEBPACK_IMPORTED_MODULE_17__/* .arrowBindingsIndex */ .w)(this);
  }
  /**
  ...
  getArrowsBoundTo(shapeId) {
    return this._getArrowBindingsIndex().get()[shapeId] || _tldraw_state__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .LZ;
  }
  getArrowInfoCache() {
    return this.store.createComputedCache("arrow infoCache", (shape) => {
      return (0,_shapes_shared_arrow_shared_mjs__WEBPACK_IMPORTED_MODULE_28__/* .getIsArrowStraight */ .el)(shape) ? (0,_shapes_shared_arrow_straight_arrow_mjs__WEBPACK_IMPORTED_MODULE_29__/* .getStraightArrowInfo */ .r)(this, shape) : (0,_shapes_shared_arrow_curved_arrow_mjs__WEBPACK_IMPORTED_MODULE_27__/* .getCurvedArrowInfo */ .p)(this, shape);
    });
  }
  /**
  ...
  annotateError(error, {
    ...
    (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .annotateError */ .lw)(error, {
  ...
  getDocumentSettings() {
    return this.store.get(_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .TLDOCUMENT_ID */ .G4);
  }
  /**
  ...
  getInstanceState() {
    return this.store.get(_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .TLINSTANCE_ID */ .PQ);
  }
  /**
  ...
  _getCurrentPageStateId() {
    return _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .InstancePageStateRecordType */ .iS.createId(this.getCurrentPageId());
  }
  /**
  ...
  getSelectedShapes() {
    ...
    return (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(selectedShapeIds.map((id) => this.store.get(id)));
  }
  /**
  ...
  getSelectionPageBounds() {
    ...
    if (selectedShapeIds.length === 0)
      return null;
    return _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.Common((0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(selectedShapeIds.map((id) => this.getShapePageBounds(id))));
  }
  ...
  getSelectionRotatedPageBounds() {
    ...
    const boxFromRotatedVertices = _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.FromPoints(
      this.getSelectedShapeIds().flatMap((id) => {
        const pageTransform = this.getShapePageTransform(id);
        if (!pageTransform)
          return [];
        return pageTransform.applyToPoints(this.getShapeGeometry(id).vertices);
      }).map((p) => _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Rot(p, -selectionRotation))
    );
  ...
  getHintingShape() {
    ...
    return (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(hintingShapeIds.map((id) => this.getShape(id)));
  }
  /**
  ...
  setHintingShapes(shapes) {
    const ids = typeof shapes[0] === "string" ? shapes : shapes.map((shape) => shape.id);
    this.updateCurrentPageState({ hintingShapeIds: (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .dedupe */ .D8)(ids) }, { ephemeral: true });
    return this;
  }
  getErasingShapeIds() {
  ...
  getErasingShapes() {
    ...
    return (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(erasingShapeIds.map((id) => this.getShape(id)));
  }
  /**
  ...
  getCameraId() {
    return _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .CameraRecordType */ .AN.createId(this.getCurrentPageId());
  }
  getCamera() {
  ...
  _setCamera(point) {
    ...
    this.batch(() => {
      ...
      const { screenBounds } = this.store.unsafeGetWithoutCapture(_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .TLINSTANCE_ID */ .PQ);
      this.dispatch({
        type: "pointer",
        target: "canvas",
        name: "pointer_move",
        // weird but true: we need to put the screen point back into client space
        point: _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.AddXY(currentScreenPoint, screenBounds.x, screenBounds.y),
        pointerId: _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .INTERNAL_POINTER_IDS */ .CK.CAMERA_MOVE,
  ...
  setCamera(point, animation) {
    ...
    if (animation) {
      ...
      return this._animateToViewport(new _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu(-x, -y, width / z, height / z), animation);
    } else {
  ...
  zoomToFit(animation) {
    ...
    if (ids.length <= 0)
      return this;
    const pageBounds = _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.Common((0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(ids.map((id) => this.getShapePageBounds(id))));
  ...
  zoomIn(point = this.getViewportScreenCenter(), animation) {
    if (!this.getInstanceState().canMoveCamera)
      return this;
    const { x: cx, y: cy, z: cz } = this.getCamera();
    let zoom = _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_ZOOM */ .sZ;
    for (let i = 1; i < _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .ZOOMS */ .E.length; i++) {
      const z1 = _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .ZOOMS */ .E[i - 1];
      const z2 = _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .ZOOMS */ .E[i];
      if (z2 - cz <= (z2 - z1) / 2)
        continue;
      zoom = z2;
      break;
  ...
  zoomOut(point = this.getViewportScreenCenter(), animation) {
    if (!this.getInstanceState().canMoveCamera)
      return this;
    const { x: cx, y: cy, z: cz } = this.getCamera();
    let zoom = _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MIN_ZOOM */ .Zj;
    for (let i = _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .ZOOMS */ .E.length - 1; i > 0; i--) {
      const z1 = _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .ZOOMS */ .E[i - 1];
      const z2 = _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .ZOOMS */ .E[i];
      if (z2 - cz >= (z2 - z1) / 2)
        continue;
  ...
  panZoomIntoView(ids, animation) {
    ...
    if (ids.length <= 0)
      return this;
    const selectionBounds = _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.Common((0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(ids.map((id) => this.getShapePageBounds(id))));
  ...
  zoomToBounds(bounds, opts) {
    ...
    let zoom = (0,_primitives_utils_mjs__WEBPACK_IMPORTED_MODULE_13__/* .clamp */ .uZ)(
      Math.min(
        (viewportScreenBounds.width - inset) / bounds.width,
        (viewportScreenBounds.height - inset) / bounds.height
      ),
      _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MIN_ZOOM */ .Zj,
      _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_ZOOM */ .sZ
    );
  ...
  _animateToViewport(targetViewportPage, opts = {}) {
    const { duration = 0, easing = _primitives_easings_mjs__WEBPACK_IMPORTED_MODULE_10__/* .EASINGS */ .L.easeInOutCubic } = opts;
  ...
  slideCamera(opts = {}) {
    ...
    const moveCamera = (elapsed) => {
      const { x: cx, y: cy, z: cz } = this.getCamera();
      const movementVec = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Mul(direction, currentSpeed * elapsed / cz);
  ...
  animateToUser(userId) {
    ...
    this.batch(() => {
      ...
      }, _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .COLLABORATOR_IDLE_TIMEOUT */ .O8);
    });
    return this;
  }
  /**
   ...
   * @public
   */
  animateToShape(shapeId, opts = _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .DEFAULT_ANIMATION_OPTIONS */ .Xy) {
    if (!this.getInstanceState().canMoveCamera)
      return this;
  ...
  getViewportScreenBounds() {
    ...
    return new _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu(x, y, w, h);
  }
  getViewportScreenCenter() {
    const viewportScreenBounds = this.getViewportScreenBounds();
    return new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(
  ...
  getViewportPageBounds() {
    ...
    const { x: cx, y: cy, z: cz } = this.getCamera();
    return new _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu(-cx, -cy, w / cz, h / cz);
  }
  ...
  startFollowingUser(userId) {
    ...
    (0,_tldraw_state__WEBPACK_IMPORTED_MODULE_0__/* .transact */ .ay)(() => {
      this.stopFollowingUser();
    ...
    const moveTowardsUser = () => {
      ...
      const chaseProportion = isOnSamePage ? _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .FOLLOW_CHASE_PROPORTION */ .CN : 1;
      if (!isOnSamePage) {
        this.stopFollowingUser();
      ...
      const leaderScreen = _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.From(leaderPresence.screenBounds);
      ...
      const leaderCenter = new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(
      ...
      const targetZoom = (0,_primitives_utils_mjs__WEBPACK_IMPORTED_MODULE_13__/* .clamp */ .uZ)(this.getCamera().z * ratio, _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MIN_ZOOM */ .Zj, _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_ZOOM */ .sZ);
      ...
      const targetCenter = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Add(center, _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Mul(displacement, chaseProportion));
      const distance = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Sub(targetCenter, center).len();
      const zoomChange = Math.abs(targetZoom - this.getCamera().z);
      if (distance < _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .FOLLOW_CHASE_PAN_SNAP */ .wi && zoomChange < _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .FOLLOW_CHASE_ZOOM_SNAP */ .Ns) {
        isCaughtUp = true;
        return;
      }
      if (isCaughtUp && distance < _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .FOLLOW_CHASE_PAN_UNSNAP */ .Qd && zoomChange < _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .FOLLOW_CHASE_ZOOM_UNSNAP */ .RH) {
        return;
      }
      isCaughtUp = false;
      this.stopCameraAnimation();
  ...
  // Camera state
  _cameraState = (0,_tldraw_state__WEBPACK_IMPORTED_MODULE_0__/* .atom */ .cn)("camera state", "idle");
  /**
  ...
  _tickCameraState = () => {
    this._cameraStateTimeoutRemaining = _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .CAMERA_MOVING_TIMEOUT */ .yV;
    const now = Date.now();
    if (this._cameraState.__unsafe__getWithoutCapture() === "idle") {
      ...
      if (now - this._lastUpdateRenderingBoundsTimestamp > _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .CAMERA_MAX_RENDERING_INTERVAL */ .aR) {
        this.updateRenderingBounds();
      }
    }
  };
  getUnorderedRenderingShapes(useEditorState) {
    ...
    let nextIndex = _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_SHAPES_PER_PAGE */ .kx * 2;
    let nextBackgroundIndex = _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_SHAPES_PER_PAGE */ .kx;
    const editingShapeId = this.getEditingShapeId();
    const selectedShapeIds = this.getSelectedShapeIds();
    const erasingShapeIds = this.getErasingShapeIds();
    ...
    const addShapeById = (id, opacity, isAncestorErasing) => {
      ...
      if (util.providesBackgroundForChildren(shape)) {
        ...
        nextIndex += _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_SHAPES_PER_PAGE */ .kx;
      }
  ...
  getRenderingShapes() {
    ...
    return renderingShapes.sort(_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .sortById */ .uv);
  }
  /**
  ...
  /** @internal */
  _renderingBounds = (0,_tldraw_state__WEBPACK_IMPORTED_MODULE_0__/* .atom */ .cn)("rendering viewport", new _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu());
  /**
  ...
  /** @internal */
  _renderingBoundsExpanded = (0,_tldraw_state__WEBPACK_IMPORTED_MODULE_0__/* .atom */ .cn)("rendering viewport expanded", new _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu());
  /**
  ...
  getPages() {
    return this._getAllPagesQuery().get().sort(_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .sortByIndex */ .hl);
  }
  /**
   * The current page.
   *
    ...
    },
    {
      do: ({ toId }) => {
        ...
        if (!this.getPageStates().find((p) => p.pageId === toId)) {
          const camera = _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .CameraRecordType */ .AN.create({
            id: _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .CameraRecordType */ .AN.createId(toId)
          });
          this.store.put([
            camera,
            _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .InstancePageStateRecordType */ .iS.create({
              id: _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .InstancePageStateRecordType */ .iS.createId(toId),
              pageId: toId
            })
          ]);
        }
  ...
  _createPage = this.history.createCommand(
    ...
    (page) => {
      if (this.getInstanceState().isReadonly)
        return null;
      if (this.getPages().length >= _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_PAGES */ .Et)
        return null;
      const pages = this.getPages();
      const name = (0,_utils_getIncrementedName_mjs__WEBPACK_IMPORTED_MODULE_33__/* .getIncrementedName */ .u)(
        page.name ?? "Page 1",
        pages.map((p) => p.name)
      );
      let index = page.index;
      if (!index || pages.some((p) => p.index === index)) {
        index = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndexAbove */ ._L)(pages[pages.length - 1].index);
      }
      const newPage = _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .PageRecordType */ .ez.create({
        meta: {},
        ...page,
        name,
        index
      });
      const newCamera = _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .CameraRecordType */ .AN.create({
        id: _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .CameraRecordType */ .AN.createId(newPage.id)
      });
      const newTabPageState = _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .InstancePageStateRecordType */ .iS.create({
        id: _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .InstancePageStateRecordType */ .iS.createId(newPage.id),
        pageId: newPage.id
      });
      return {
        data: {
   ...
   * @public
   */
  duplicatePage(page, createId = _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .PageRecordType */ .ez.createId()) {
    if (this.getPages().length >= _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_PAGES */ .Et)
      return this;
    const id = typeof page === "string" ? page : page.id;
    ...
    this.batch(() => {
      const pages = this.getPages();
      const index = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndexBetween */ .eI)(freshPage.index, pages[pages.indexOf(freshPage) + 1]?.index);
  ...
  _deleteAssets = this.history.createCommand(
    ...
    (ids) => {
      ...
      if (ids.length <= 0)
        return;
      const prev = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(ids.map((id) => this.store.get(id)));
  ...
  getShapeLocalTransform(shape) {
    ...
    return _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.Identity().translate(freshShape.x, freshShape.y).rotate(freshShape.rotation);
  }
  _getShapePageTransformCache() {
    return this.store.createComputedCache("pageTransformCache", (shape) => {
      if ((0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isPageId */ .r5)(shape.parentId)) {
        return this.getShapeLocalTransform(shape);
      }
      const parentTransform = this._getShapePageTransformCache().get(shape.parentId) ?? _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.Identity();
      return _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.Compose(parentTransform, this.getShapeLocalTransform(shape));
    });
  }
  /**
  ...
  getShapeParentTransform(shape) {
    const id = typeof shape === "string" ? shape : shape.id;
    const freshShape = this.getShape(id);
    if (!freshShape || (0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isPageId */ .r5)(freshShape.parentId))
      return _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.Identity();
    return this._getShapePageTransformCache().get(freshShape.parentId) ?? _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.Identity();
  }
  /**
  ...
  getShapePageTransform(shape) {
    ...
    return this._getShapePageTransformCache().get(id) ?? _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.Identity();
  }
  _getShapePageBoundsCache() {
    return this.store.createComputedCache("pageBoundsCache", (shape) => {
      const pageTransform = this._getShapePageTransformCache().get(shape.id);
      if (!pageTransform)
        return new _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu();
      const result = _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.FromPoints(
        _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.applyToPoints(pageTransform, this.getShapeGeometry(shape).vertices)
      );
      return result;
    });
  }
  ...
  _getShapeClipPathCache() {
    return this.store.createComputedCache("clipPathCache", (shape) => {
      ...
      if (!pageTransform)
        return void 0;
      const localMask = _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.applyToPoints(_primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.Inverse(pageTransform), pageMask);
  ...
  _getShapeMaskCache() {
    return this.store.createComputedCache("pageMaskCache", (shape) => {
      ...
      const pageMask = frameAncestors.map(
        ...
        if (!(b && acc))
          return void 0;
        const intersection = (0,_primitives_intersect_mjs__WEBPACK_IMPORTED_MODULE_12__/* .intersectPolygonPolygon */ .tY)(acc, b);
        if (intersection) {
          return intersection.map(_primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Cast);
        }
        return [];
      });
      return pageMask;
  ...
  getShapeMaskedPageBounds(shape) {
    ...
    if (pageMask) {
      ...
      if (corners.every((p, i) => p && _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Equals(p, pageMask[i])))
        return pageBounds.clone();
      const intersection = (0,_primitives_intersect_mjs__WEBPACK_IMPORTED_MODULE_12__/* .intersectPolygonPolygon */ .tY)(pageMask, corners);
      if (!intersection)
        return;
      return _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.FromPoints(intersection);
    }
    return pageBounds;
  }
  /**
  ...
  getShapeAncestors(shape, acc = []) {
    ...
    if ((0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isPageId */ .r5)(parentId)) {
      acc.reverse();
      return acc;
    }
  ...
  findCommonAncestor(shapes, predicate) {
    ...
    const freshShapes = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(ids.map((id) => this.getShape(id)));
  ...
  getShapeAtPoint(point, opts = {}) {
    ...
    const shapesToCheck = (opts.renderingOnly ? this.getCurrentPageRenderingShapesSorted() : this.getCurrentPageShapesSorted()).filter((shape) => {
      ...
      if (pageMask && !(0,_primitives_utils_mjs__WEBPACK_IMPORTED_MODULE_13__/* .pointInPolygon */ .Of)(point, pageMask))
        return false;
      if (filter)
        return filter(shape);
      return true;
    ...
    for (let i = shapesToCheck.length - 1; i >= 0; i--) {
      ...
      const isGroup = geometry instanceof _primitives_geometry_Group2d_mjs__WEBPACK_IMPORTED_MODULE_11__/* .Group2d */ .m;
      ...
      if (geometry.isClosed) {
        ...
        if (distance < _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .HIT_TEST_MARGIN */ .wM / zoomLevel) {
          return shape;
        }
      }
    }
  ...
  getPointInParentSpace(shape, point) {
    ...
    const freshShape = this.getShape(id);
    if (!freshShape)
      return new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(0, 0);
    if ((0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isPageId */ .r5)(freshShape.parentId))
      return _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.From(point);
  ...
  getCurrentPageShapesSorted() {
    const shapes = new Set(this.getCurrentPageShapes().sort(_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .sortByIndex */ .hl));
    const results = [];
    ...
    shapes.forEach((shape) => {
      ...
      if (!(0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isShape */ .VV)(parent)) {
  ...
  getShape(shape) {
    const id = typeof shape === "string" ? shape : shape.id;
    if (!(0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isShapeId */ .YT)(id))
      return void 0;
  ...
  getShapeParent(shape) {
    ...
    if (!id)
      return void 0;
    const freshShape = this.getShape(id);
    if (freshShape === void 0 || !(0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isShapeId */ .YT)(freshShape.parentId))
      return void 0;
  ...
  getAncestorPageId(shape) {
    ...
    if (!_shape)
      return void 0;
    if ((0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isPageId */ .r5)(_shape.parentId)) {
  ...
  reparentShapes(shapes, parentId, insertIndex) {
    ...
    if (ids.length === 0)
      return this;
    const changes = [];
    const parentTransform = (0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isPageId */ .r5)(parentId) ? _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.Identity() : this.getShapePageTransform(parentId);
    const parentPageRotation = parentTransform.rotation();
    let indices = [];
    const sibs = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(this.getSortedChildIdsForParent(parentId).map((id) => this.getShape(id)));
    if (insertIndex) {
      const sibWithInsertIndex = sibs.find((s) => s.index === insertIndex);
      if (sibWithInsertIndex) {
        const sibAbove = sibs[sibs.indexOf(sibWithInsertIndex) + 1];
        if (sibAbove) {
          indices = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndicesBetween */ .Xv)(insertIndex, sibAbove.index, ids.length);
        } else {
          indices = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndicesAbove */ .vw)(insertIndex, ids.length);
        }
      } else {
        const sibAbove = sibs.sort(_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .sortByIndex */ .hl).find((s) => s.index > insertIndex);
        if (sibAbove) {
          indices = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndicesBetween */ .Xv)(insertIndex, sibAbove.index, ids.length);
        } else {
          indices = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndicesAbove */ .vw)(insertIndex, ids.length);
      ...
      indices = sib ? (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndicesAbove */ .vw)(sib.index, ids.length) : (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndices */ .H$)(ids.length);
    }
    const invertedParentTransform = parentTransform.clone().invert();
    const shapesToReparent = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(ids.map((id) => this.getShape(id)));
  ...
  getHighestIndexForParent(parent) {
    ...
    return (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndexAbove */ ._L)(shape.index);
  }
  /**
   ...
   * @internal
   */
  _childIdsCache = new _utils_WeakMapCache_mjs__WEBPACK_IMPORTED_MODULE_34__/* .WeakMapCache */ ._();
  /**
  ...
  getSortedChildIdsForParent(parent) {
    ...
    if (!ids)
      return _tldraw_state__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_ARRAY */ .LZ;
  ...
  rotateShapesBy(shapes, delta) {
    ...
    if (ids.length <= 0)
      return this;
    const snapshot = (0,_utils_rotation_mjs__WEBPACK_IMPORTED_MODULE_16__/* .getRotationSnapshot */ .o)({ editor: this });
    if (!snapshot)
      return this;
    (0,_utils_rotation_mjs__WEBPACK_IMPORTED_MODULE_16__/* .applyRotationToSnapshotShapes */ .Z)({ delta, snapshot, editor: this, stage: "one-off" });
    return this;
  }
  ...
  nudgeShapes(shapes, offset, historyOptions) {
    ...
    for (const id of ids) {
      const shape = this.getShape(id);
      const localDelta = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.From(offset);
  ...
  duplicateShapes(shapes, offset) {
    ...
    idsToCreate.reverse();
    const idsMap = new Map(idsToCreate.map((id) => [id, (0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .createShapeId */ .F1)()]));
    const shapesToCreate = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(
      idsToCreate.map((id) => {
        const shape = this.getShape(id);
        if (!shape) {
          return null;
        ...
        if (offset && initialIds.has(id)) {
          const parentTransform = this.getShapeParentTransform(shape);
          const vec = new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(offset.x, offset.y).rot(-parentTransform.rotation());
          ox = vec.x;
          oy = vec.y;
        }
        ...
        const index = siblingAbove ? (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndexBetween */ .eI)(shape.index, siblingAbove.index) : (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndexAbove */ ._L)(shape.index);
        let newShape = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .deepCopy */ .p$)(shape);
        if (this.isShapeOfType(shape, "arrow") && this.isShapeOfType(newShape, "arrow")) {
          ...
          if (shape.props.start.type === "binding") {
            ...
            if (!newStartShapeId) {
              if (info?.isValid) {
                ...
                const { start } = (0,_shapes_shared_arrow_shared_mjs__WEBPACK_IMPORTED_MODULE_28__/* .getArrowTerminalsInArrowSpace */ .Qs)(this, shape);
                newShape.props.start = {
                  type: "point",
                  x: start.x,
                  y: start.y
          ...
          if (shape.props.end.type === "binding") {
            ...
            if (!newEndShapeId) {
              if (info?.isValid) {
                ...
                const { end } = (0,_shapes_shared_arrow_shared_mjs__WEBPACK_IMPORTED_MODULE_28__/* .getArrowTerminalsInArrowSpace */ .Qs)(this, shape);
                newShape.props.start = {
                  type: "point",
                  x: end.x,
                  y: end.y
          ...
          const infoAfter = (0,_shapes_shared_arrow_shared_mjs__WEBPACK_IMPORTED_MODULE_28__/* .getIsArrowStraight */ .el)(newShape) ? (0,_shapes_shared_arrow_straight_arrow_mjs__WEBPACK_IMPORTED_MODULE_29__/* .getStraightArrowInfo */ .r)(this, newShape) : (0,_shapes_shared_arrow_curved_arrow_mjs__WEBPACK_IMPORTED_MODULE_27__/* .getCurvedArrowInfo */ .p)(this, newShape);
          if (info?.isValid && infoAfter?.isValid && !(0,_shapes_shared_arrow_shared_mjs__WEBPACK_IMPORTED_MODULE_28__/* .getIsArrowStraight */ .el)(shape)) {
            const mpA = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Med(info.start.handle, info.end.handle);
            const distA = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Dist(info.middle, mpA);
            const distB = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Dist(infoAfter.middle, mpA);
    ...
    shapesToCreate.forEach((shape) => {
      if ((0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isShapeId */ .YT)(shape.parentId)) {
    ...
    this.history.batch(() => {
      const maxShapesReached = shapesToCreate.length + this.getCurrentPageShapeIds().size > _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_SHAPES_PER_PAGE */ .kx;
      if (maxShapesReached) {
        alertMaxShapes(this);
      }
      const newShapes = maxShapesReached ? shapesToCreate.slice(0, _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_SHAPES_PER_PAGE */ .kx - this.getCurrentPageShapeIds().size) : shapesToCreate;
      ...
      if (offset !== void 0) {
        ...
        if (selectionPageBounds && !viewportPageBounds.contains(selectionPageBounds)) {
          this.centerOnPoint(selectionPageBounds.center, {
            duration: _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .ANIMATION_MEDIUM_MS */ .KD
          });
        }
      }
    });
  ...
  moveShapesToPage(shapes, pageId) {
    ...
    if (!content)
      return this;
    if (this.getPageShapeIds(pageId).size + content.shapes.length > _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_SHAPES_PER_PAGE */ .kx) {
  ...
  sendToBack(shapes) {
    const ids = typeof shapes[0] === "string" ? shapes : shapes.map((s) => s.id);
    const changes = (0,_utils_reorderShapes_mjs__WEBPACK_IMPORTED_MODULE_15__/* .getReorderingShapesChanges */ .B)(this, "toBack", ids);
    if (changes)
      this.updateShapes(changes);
    return this;
  }
  ...
  sendBackward(shapes) {
    const ids = typeof shapes[0] === "string" ? shapes : shapes.map((s) => s.id);
    const changes = (0,_utils_reorderShapes_mjs__WEBPACK_IMPORTED_MODULE_15__/* .getReorderingShapesChanges */ .B)(this, "backward", ids);
    if (changes)
      this.updateShapes(changes);
    return this;
  }
  ...
  bringForward(shapes) {
    const ids = typeof shapes[0] === "string" ? shapes : shapes.map((s) => s.id);
    const changes = (0,_utils_reorderShapes_mjs__WEBPACK_IMPORTED_MODULE_15__/* .getReorderingShapesChanges */ .B)(this, "forward", ids);
    if (changes)
      this.updateShapes(changes);
    return this;
  }
  ...
  bringToFront(shapes) {
    const ids = typeof shapes[0] === "string" ? shapes : shapes.map((s) => s.id);
    const changes = (0,_utils_reorderShapes_mjs__WEBPACK_IMPORTED_MODULE_15__/* .getReorderingShapesChanges */ .B)(this, "toFront", ids);
    if (changes)
      this.updateShapes(changes);
    return this;
  }
  ...
  flipShapes(shapes, operation) {
    ...
    if (this.getInstanceState().isReadonly)
      return this;
    let shapesToFlip = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(ids.map((id) => this.getShape(id)));
    if (!shapesToFlip.length)
      return this;
    shapesToFlip = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(
    ...
    const scaleOriginPage = _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.Common(
      (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(shapesToFlip.map((id) => this.getShapePageBounds(id)))
    ).center;
    this.batch(() => {
  ...
  stackShapes(shapes, operation, gap) {
    ...
    if (this.getInstanceState().isReadonly)
      return this;
    const shapesToStack = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(
    ...
    shapesToStack.forEach((shape, i) => {
      ...
      const localDelta = parent ? _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Rot(delta, -this.getShapePageTransform(parent).decompose().rotation) : delta;
  ...
  packShapes(shapes, gap) {
    ...
    if (ids.length < 2)
      return this;
    const shapesToPack = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(
    ...
    const commonBounds = _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.Common((0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(Object.values(shapePageBounds)));
    const maxWidth = commonBounds.width;
    shapesToPack.sort((a, b) => shapePageBounds[b.id].height - shapePageBounds[a.id].height);
    const startWidth = Math.max(Math.ceil(Math.sqrt(area / 0.95)), maxWidth);
    const spaces = [new _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu(commonBounds.x, commonBounds.y, startWidth, Infinity)];
    let width = 0;
    let height = 0;
    let space;
    let last;
    for (let i = 0; i < shapesToPack.length; i++) {
      ...
      for (let i2 = spaces.length - 1; i2 >= 0; i2--) {
        ...
        if (bounds.width === space.width && bounds.height === space.height) {
          ...
          spaces.push(
            new _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu(
              space.x + (bounds.width + gap),
              space.y,
              space.width - (bounds.width + gap),
              bounds.height
    ...
    const commonAfter = _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.Common(Object.values(nextShapePageBounds));
    const centerDelta = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Sub(commonBounds.center, commonAfter.center);
    let nextBounds;
    const changes = [];
    for (let i = 0; i < shapesToPack.length; i++) {
      shape = shapesToPack[i];
      ...
      const delta = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Sub(nextBounds.point, bounds.point).add(centerDelta);
      const parentTransform = this.getShapeParentTransform(shape);
      if (parentTransform)
  ...
  alignShapes(shapes, operation) {
    ...
    if (ids.length < 2)
      return this;
    const shapesToAlign = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(ids.map((id) => this.getShape(id)));
    ...
    shapesToAlign.forEach((shape) => {
      ...
      const parent = this.getShapeParent(shape);
      const localDelta = parent ? _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Rot(delta, -this.getShapePageTransform(parent).decompose().rotation) : delta;
      changes.push(this.getChangesToTranslateShape(shape, _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Add(shape, localDelta)));
    });
    this.updateShapes(changes);
    return this;
  }
  ...
  distributeShapes(shapes, operation) {
    ...
    const shapesToDistribute = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(ids.map((id) => this.getShape(id)));
    const pageBounds = Object.fromEntries(
    ...
    shapesToDistribute.filter((shape) => shape !== first && shape !== last).sort((a, b) => pageBounds[a.id][mid] - pageBounds[b.id][mid]).forEach((shape, i) => {
      ...
      const parent = this.getShapeParent(shape);
      const localDelta = parent ? _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Rot(delta, -this.getShapePageTransform(parent).rotation()) : delta;
      changes.push(this.getChangesToTranslateShape(shape, _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Add(shape, localDelta)));
    });
    this.updateShapes(changes);
    return this;
  ...
  stretchShapes(shapes, operation) {
    ...
    if (ids.length < 2)
      return this;
    const shapesToStretch = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(ids.map((id) => this.getShape(id)));
      ...
      case "vertical": {
        this.batch(() => {
          for (const shape of shapesToStretch) {
            ...
            if (pageRotation % _primitives_utils_mjs__WEBPACK_IMPORTED_MODULE_13__/* .PI2 */ .yo)
              continue;
            const bounds = shapeBounds[shape.id];
            const pageBounds = shapePageBounds[shape.id];
            const localOffset = new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(0, commonBounds.minY - pageBounds.minY);
            const parentTransform = this.getShapeParentTransform(shape);
            if (parentTransform)
              localOffset.rot(-parentTransform.rotation());
            const { x, y } = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Add(localOffset, shape);
            this.updateShapes([{ id: shape.id, type: shape.type, x, y }], { squashing: true });
            const scale = new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(1, commonBounds.height / pageBounds.height);
            this.resizeShape(shape.id, scale, {
              initialBounds: bounds,
              scaleOrigin: new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(pageBounds.center.x, commonBounds.minY),
              scaleAxisRotation: 0
            });
          }
        });
      ...
      case "horizontal": {
        this.batch(() => {
          for (const shape of shapesToStretch) {
            ...
            if (pageRotation % _primitives_utils_mjs__WEBPACK_IMPORTED_MODULE_13__/* .PI2 */ .yo)
              continue;
            const localOffset = new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(commonBounds.minX - pageBounds.minX, 0);
            const parentTransform = this.getShapeParentTransform(shape);
            if (parentTransform)
              localOffset.rot(-parentTransform.rotation());
            const { x, y } = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Add(localOffset, shape);
            this.updateShapes([{ id: shape.id, type: shape.type, x, y }], { squashing: true });
            const scale = new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(commonBounds.width / pageBounds.width, 1);
            this.resizeShape(shape.id, scale, {
              initialBounds: bounds,
              scaleOrigin: new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(commonBounds.minX, pageBounds.center.y),
              scaleAxisRotation: 0
            });
          }
        });
  ...
  resizeShape(shape, scale, options = {}) {
    ...
    if (!Number.isFinite(scale.x))
      scale = new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(1, scale.y);
    if (!Number.isFinite(scale.y))
      scale = new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(scale.x, 1);
    ...
    if (!scaleOrigin)
      return this;
    const pageTransform = options.initialPageTransform ? _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.Cast(options.initialPageTransform) : this.getShapePageTransform(id);
    if (!pageTransform)
      return this;
    ...
    if (!initialBounds)
      return this;
    if (!(0,_primitives_utils_mjs__WEBPACK_IMPORTED_MODULE_13__/* .areAnglesCompatible */ ._G)(pageRotation, scaleAxisRotation)) {
    ...
    if (util.isAspectRatioLocked(initialShape)) {
      if (Math.abs(scale.x) > Math.abs(scale.y)) {
        scale = new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(scale.x, Math.sign(scale.y) * Math.abs(scale.x));
      } else {
        scale = new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(Math.sign(scale.x) * Math.abs(scale.y), scale.y);
      }
    }
    if (util.onResize && util.canResize(initialShape)) {
      const newPagePoint = this._scalePagePoint(
        _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.applyToPoint(pageTransform, new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(0, 0)),
        scaleOrigin,
        scale,
        scaleAxisRotation
      );
      const newLocalPoint = this.getPointInParentSpace(initialShape.id, newPagePoint);
      const myScale = new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(scale.x, scale.y);
      const areWidthAndHeightAlignedWithCorrectAxis = (0,_primitives_utils_mjs__WEBPACK_IMPORTED_MODULE_13__/* .approximately */ .C2)(
        (pageRotation - scaleAxisRotation) % Math.PI,
        0
      );
      myScale.x = areWidthAndHeightAlignedWithCorrectAxis ? scale.x : scale.y;
      myScale.y = areWidthAndHeightAlignedWithCorrectAxis ? scale.y : scale.x;
      const initialPagePoint = _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.applyToPoint(pageTransform, new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B());
      ...
      const initialPageCenter = _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.applyToPoint(pageTransform, initialBounds.center);
      ...
      const delta = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Sub(newPageCenterInParentSpace, initialPageCenterInParentSpace);
      this.updateShapes(
        [
          {
            id,
  ...
  _scalePagePoint(point, scaleOrigin, scale, scaleAxisRotation) {
    const relativePoint = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.RotWith(point, scaleOrigin, -scaleAxisRotation).sub(scaleOrigin);
    const newRelativePagePoint = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.MulV(relativePoint, scale);
    const destination = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Add(newRelativePagePoint, scaleOrigin).rotWith(
      scaleOrigin,
      scaleAxisRotation
    );
    return destination;
  ...
  _resizeUnalignedShape(id, scale, options) {
    ...
    const shapeScale = new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(scale.x, scale.y);
    if (Math.abs(scale.x) > Math.abs(scale.y)) {
    ...
    if (Math.sign(scale.x) * Math.sign(scale.y) < 0) {
      let { rotation } = _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.Decompose(options.initialPageTransform);
      rotation -= 2 * rotation;
      this.updateShapes([{ id, type, rotation }], { squashing: true });
    }
    const preScaleShapePageCenter = _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.applyToPoint(
    ...
    if (!currentPageCenter || !shapePageTransformOrigin)
      return this;
    const pageDelta = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Sub(postScaleShapePageCenter, currentPageCenter);
    const postScaleShapePagePoint = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Add(shapePageTransformOrigin, pageDelta);
  ...
  _createShapes = this.history.createCommand(
    ...
    (partials) => {
      ...
      const maxShapesReached = partials.length + currentPageShapeIds.size > _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_SHAPES_PER_PAGE */ .kx;
      if (maxShapesReached) {
        alertMaxShapes(this);
        return;
      }
      ...
      return {
        data: {
          ...
          partials: partials.map(
            (p) => p.id ? p : { ...p, id: (0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .createShapeId */ .F1)() }
          )
        }
      };
    },
      ...
      do: ({ partials }) => {
        ...
        partials = partials.map((partial) => {
          if (!partial.parentId || !(this.store.has(partial.parentId) || partials.some((p) => p.id === partial.parentId))) {
            ...
            if (parentId !== prevParentId) {
              ...
              if ((0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isShapeId */ .YT)(parentId)) {
        ...
        for (const partial of partials) {
          ...
          if (!index) {
            ...
            parentIndices.set(parentId, (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndexAbove */ ._L)(index));
          }
  ...
  animateShapes(partials, animationOptions = {}) {
    const { duration = 500, easing = _primitives_easings_mjs__WEBPACK_IMPORTED_MODULE_10__/* .EASINGS */ .L.linear } = animationOptions;
    const animationId = (0,_utils_uniqueId_mjs__WEBPACK_IMPORTED_MODULE_35__/* .uniqueId */ .E)();
   ...
   * @public
   */
  groupShapes(shapes, groupId = (0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .createShapeId */ .F1)()) {
    if (!Array.isArray(shapes)) {
    ...
    if (ids.length <= 1)
      return this;
    const shapesToGroup = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(this._getUnlockedShapeIds(ids).map((id) => this.getShape(id)));
    const sortedShapeIds = shapesToGroup.sort(_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .sortByIndex */ .hl).map((s) => s.id);
    const pageBounds = _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.Common((0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(shapesToGroup.map((id) => this.getShapePageBounds(id))));
    ...
    const shapesWithRootParent = shapesToGroup.filter((shape) => shape.parentId === parentId).sort(_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .sortByIndex */ .hl);
  ...
  ungroupShapes(_ids) {
    ...
    const shapes = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(ids.map((id) => this.getShape(id)));
    const groups = [];
    shapes.forEach((shape) => {
      if (this.isShapeOfType(shape, "group")) {
        groups.push(shape);
  ...
  _updateShapes = this.history.createCommand(
    ...
    },
    {
      do: ({ updates }) => {
        this.store.put(
          (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .objectMapValues */ .UM)(updates).map((shape) => {
  ...
  _deleteShapes = this.history.createCommand(
    ...
    (ids) => {
      ...
      const snapshots = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(
  ...
  _extractSharedStyles(shape, sharedStyleMap) {
    if (this.isShapeOfType(shape, "group")) {
      ...
      for (const [style, propKey] of this.styleProps[shape.type]) {
        sharedStyleMap.applyValue(style, (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnProperty */ .eg)(shape.props, propKey));
      }
    }
  }
  _getSelectionSharedStyles() {
    const selectedShapes = this.getSelectedShapes();
    const sharedStyles = new _utils_SharedStylesMap_mjs__WEBPACK_IMPORTED_MODULE_14__/* .SharedStyleMap */ .o();
  ...
  getShapeStyleIfExists(shape, style) {
    ...
    if (styleKey === void 0)
      return void 0;
    return (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnProperty */ .eg)(shape.props, styleKey);
  }
  getSharedStyles() {
    ...
    const styles = new _utils_SharedStylesMap_mjs__WEBPACK_IMPORTED_MODULE_14__/* .SharedStyleMap */ .o();
    if (!currentTool)
      return styles;
  ...
  getContentFromCurrentPage(shapes) {
    ...
    let shapesForContent = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .dedupe */ .D8)(
      ids.map((id) => this.getShape(id)).sort(_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .sortByIndex */ .hl).flatMap((shape) => {
    ...
    shapesForContent = shapesForContent.map((shape) => {
      ...
      shape = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .structuredClone */ .v4)(shape);
      if (this.isShapeOfType(shape, "arrow")) {
        ...
        const infoAfter = (0,_shapes_shared_arrow_shared_mjs__WEBPACK_IMPORTED_MODULE_28__/* .getIsArrowStraight */ .el)(shape) ? (0,_shapes_shared_arrow_straight_arrow_mjs__WEBPACK_IMPORTED_MODULE_29__/* .getStraightArrowInfo */ .r)(this, shape) : (0,_shapes_shared_arrow_curved_arrow_mjs__WEBPACK_IMPORTED_MODULE_27__/* .getCurvedArrowInfo */ .p)(this, shape);
        if (info?.isValid && infoAfter?.isValid && !(0,_shapes_shared_arrow_shared_mjs__WEBPACK_IMPORTED_MODULE_28__/* .getIsArrowStraight */ .el)(shape)) {
          const mpA = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Med(info.start.handle, info.end.handle);
          const distA = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Dist(info.middle, mpA);
          const distB = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Dist(infoAfter.middle, mpA);
    ...
    return {
      ...
      assets: (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(Array.from(assetsSet).map((id) => this.getAsset(id)))
    };
  }
  /**
  ...
  putContentOntoCurrentPage(content, options = {}) {
    ...
    const idMap = new Map(shapes.map((shape) => [shape.id, (0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .createShapeId */ .F1)()]));
    ...
    if (!(0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isPageId */ .r5)(pasteParentId)) {
    ...
    const newShapes = shapes.map((shape) => {
      let newShape;
      if (preserveIds) {
        newShape = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .deepCopy */ .p$)(shape);
        idMap.set(shape.id, shape.id);
      } else {
        const id = idMap.get(shape.id);
        newShape = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .deepCopy */ .p$)({ ...shape, id });
      }
      ...
      if (idMap.has(newShape.parentId)) {
        ...
        index = (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .getIndexAbove */ ._L)(index);
      }
    ...
    if (newShapes.length + this.getCurrentPageShapeIds().size > _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_SHAPES_PER_PAGE */ .kx) {
      alertMaxShapes(this);
      return this;
    }
    let assetsToCreate = [];
    ...
    assetsToCreate = assets.filter((asset) => !this.store.has(asset.id)).map((asset) => {
      if (asset.type === "image" || asset.type === "video") {
        if (asset.props.src && asset.props.src?.startsWith("data:image")) {
          assetsToUpdate.push((0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .structuredClone */ .v4)(asset));
    ...
    Promise.allSettled(
      assetsToUpdate.map(async (asset) => {
        const file = await (0,_utils_assets_mjs__WEBPACK_IMPORTED_MODULE_36__/* .dataUrlToFile */ .B)(
          asset.props.src,
          asset.props.name,
      ...
      this.updateAssets(
        (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(
          assets2.map(
    ...
    this.batch(() => {
      ...
      const bounds = _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.Common(newCreatedShapes.map((s) => this.getShapePageBounds(s)));
      if (point === void 0) {
        if (!(0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .isPageId */ .r5)(pasteParentId)) {
          const shape = this.getShape(pasteParentId);
          point = _primitives_Mat_mjs__WEBPACK_IMPORTED_MODULE_8__/* .Mat */ ._.applyToPoint(
            this.getShapePageTransform(shape),
            this.getShapeGeometry(shape).bounds.center
          );
        } else {
          const viewportPageBounds = this.getViewportPageBounds();
          if (preservePosition || viewportPageBounds.includes(_primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.From(bounds))) {
            point = bounds.center;
          } else {
      ...
      const pageCenter = _primitives_Box_mjs__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .xu.Common(
        (0,_tldraw_utils__WEBPACK_IMPORTED_MODULE_2__/* .compact */ .oA)(rootShapes.map(({ id }) => this.getShapePageBounds(id)))
      ).center;
      const offset = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Sub(point, pageCenter);
      this.updateShapes(
        rootShapes.map(({ id }) => {
          const s = this.getShape(id);
          const localRotation = this.getShapeParentTransform(id).decompose().rotation;
          const localDelta = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Rot(offset, -localRotation);
  ...
  async getSvg(shapes, opts = {}) {
    ...
    const {
      scale = 1,
      background = false,
      padding = _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .SVG_PADDING */ .s_,
      preserveAspectRatio = false
    } = opts;
    const isDarkMode = opts.darkMode ?? this.user.getIsDarkMode();
    const theme = (0,_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .getDefaultColorTheme */ .y6)({ isDarkMode });
    ...
    const unorderedShapeElements = (await Promise.all(
      renderingShapes.map(async ({ id, opacity, index, backgroundIndex }) => {
        ...
        if (pageMask) {
          ...
          const id2 = (0,_utils_uniqueId_mjs__WEBPACK_IMPORTED_MODULE_35__/* .uniqueId */ .E)();
          clipPathEl.id = id2;
  ...
  inputs = {
    ...
    originPagePoint: new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(),
    /** The most recent pointer down's position in screen space. */
    originScreenPoint: new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(),
    /** The previous pointer position in the current page space. */
    previousPagePoint: new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(),
    /** The previous pointer position in screen space. */
    previousScreenPoint: new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(),
    /** The most recent pointer position in the current page space. */
    currentPagePoint: new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(),
    /** The most recent pointer position in screen space. */
    currentScreenPoint: new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B(),
    ...
    pointerVelocity: new _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B()
  };
  /**
  ...
  _updateInputsFromEvent(info) {
    ...
    this.store.put([
      {
        id: _tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .TLPOINTER_ID */ .LV,
        typeName: "pointer",
        ...
        lastActivityTimestamp: (
          ...
          (info.type === "pointer" && info.pointerId === _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .INTERNAL_POINTER_IDS */ .CK.CAMERA_MOVE ? this.store.get(_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .TLPOINTER_ID */ .LV)?.lastActivityTimestamp ?? Date.now() : Date.now())
        ),
        meta: {}
      }
    ]);
   ...
   * @internal
   */
  _clickManager = new _managers_ClickManager_mjs__WEBPACK_IMPORTED_MODULE_20__/* .ClickManager */ .o(this);
  /**
        ...
        case "pinch": {
          ...
          switch (info.name) {
            ...
            case "pinch": {
              ...
              const { screenBounds } = this.store.unsafeGetWithoutCapture(_tldraw_tlschema__WEBPACK_IMPORTED_MODULE_1__/* .TLINSTANCE_ID */ .PQ);
              const { x, y } = _primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.SubXY(info.point, screenBounds.x, screenBounds.y);
              const { x: cx, y: cy, z: cz } = this.getCamera();
              const zoom = Math.min(_constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_ZOOM */ .sZ, Math.max(_constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MIN_ZOOM */ .Zj, z));
              this.setCamera({
        ...
        case "wheel": {
          ...
          if (this.getIsMenuOpen()) {
            ...
            if (inputs.ctrlKey) {
              ...
              const { x: cx, y: cy, z: cz } = this.getCamera();
              const zoom = Math.min(_constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_ZOOM */ .sZ, Math.max(_constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MIN_ZOOM */ .Zj, cz + (info.delta.z ?? 0) * cz));
              this.setCamera({
                x: cx + (x / zoom - x) - (x / cz - x),
                y: cy + (y / zoom - y) - (y / cz - y),
                z: zoom
            ...
            this.pan(info.delta);
            if (!inputs.isDragging && inputs.isPointing && originPagePoint.dist(currentPagePoint) > (this.getInstanceState().isCoarsePointer ? _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .COARSE_DRAG_DISTANCE */ .UD : _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .DRAG_DISTANCE */ .Sk) / this.getZoomLevel()) {
          ...
          switch (info.name) {
            ...
            case "pointer_move": {
              ...
              if (this.inputs.isPanning && this.inputs.isPointing) {
                ...
                this.pan(_primitives_Vec_mjs__WEBPACK_IMPORTED_MODULE_9__/* .Vec */ .B.Sub(currentScreenPoint2, previousScreenPoint));
                return;
              }
              if (!inputs.isDragging && inputs.isPointing && originPagePoint.dist(currentPagePoint) > (this.getInstanceState().isCoarsePointer ? _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .COARSE_DRAG_DISTANCE */ .UD : _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .DRAG_DISTANCE */ .Sk) / this.getZoomLevel()) {
                inputs.isDragging = true;
                ...
                if (info.button === 1) {
                  if (!this.inputs.keys.has(" ")) {
                    ...
                    this.slideCamera({
                      ...
                      friction: _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .CAMERA_SLIDE_FRICTION */ .$G
                    });
                    this.updateInstanceState({
...
__decorateClass([
  (0,_tldraw_state__WEBPACK_IMPORTED_MODULE_0__/* .computed */ .Fl)({ isEqual: (a, b) => a.equals(b) })
...
function alertMaxShapes(editor, pageId = editor.getCurrentPageId()) {
  ...
  editor.emit("max-shapes", { name, pageId, count: _constants_mjs__WEBPACK_IMPORTED_MODULE_6__/* .MAX_SHAPES_PER_PAGE */ .kx });
}
...
//# sourceMappingURL=ab16df01.6c089e8204acc7c8.js.map
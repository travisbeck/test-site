...
/* harmony export */ });
/* harmony import */ var _callback__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(33404);
...
function link(links, event, properties, options) {
    ...
    elements.forEach(function (el) {
        el.addEventListener('click', function (elementEvent) {
            ...
            var trackEvent = (0,_callback__WEBPACK_IMPORTED_MODULE_0__/* .pTimeout */ .F)(_this.track(ev, props, options !== null && options !== void 0 ? options : {}), (_b = _this.settings.timeout) !== null && _b !== void 0 ? _b : 500);
...
function form(forms, event, properties, options) {
    ...
    elements.forEach(function (el) {
        ...
        var handler = function (elementEvent) {
            ...
            var ev = event instanceof Function ? event(el) : event;
            var props = properties instanceof Function ? properties(el) : properties;
            var trackEvent = (0,_callback__WEBPACK_IMPORTED_MODULE_0__/* .pTimeout */ .F)(_this.track(ev, props, options !== null && options !== void 0 ? options : {}), (_a = _this.settings.timeout) !== null && _a !== void 0 ? _a : 500);
            trackEvent
                .catch(console.error)
                .then(function () {
                el.submit();
...
//# sourceMappingURL=auto-track.6aa75311be8d645d.js.map